...
const rpcUrl = (method) => process.env.NODE_ENV === 'production' ? '/rpc' : `/rpc?__m=${method}`

const make = (url, body) => (
  request('POST', url, body)
)

export const send = (method, params = {}, id = newId()) => (
  (dispatch) => dispatch(make, rpcUrl(method), { method, params, id })
)
